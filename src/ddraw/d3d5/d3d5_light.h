...
namespace dxvk {
  ...
  class D3D5Light final : public DDrawWrappedObject<D3D5Interface, IDirect3DLight, IUnknown> {

  public:

    D3D5Light(Com<IDirect3DLight>&& proxyLight, D3D5Interface* pParent);
    ...
    void SetViewport(D3D5Viewport* viewport) {
      m_viewport = viewport;
    }
